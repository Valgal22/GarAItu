 ...
 * @author Shai Almog
 */
public class MemoryLensStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MemoryLens";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MemoryLensStub());
    }
